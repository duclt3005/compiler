...
struct ErrorMessage errors[33] = {
    ...
    // CONst  d = 123.4 ; d= -d; Type t = Float ;Var n : d;
    ...
    //Function F(FLoat n : Integer) : Integer;
    ...
    // trong function:  Function F(n : Integer) : Integer
    ...
    {ERR_ARRAY_OVERFLOW, "Array is overflow!"}
    };
