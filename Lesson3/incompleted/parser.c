...
//	printf("\n%s", tokenToString(tokenType));
//	printf("--%s", tokenToString(lookAhead->tokenType));
...
void compileTypeDecls(void) {
  // TODO
  assert("Parsing types decls ...");
  while (lookAhead->tokenType == TK_IDENT)
      compileTypeDecl();
  assert("Types decls parsed!");
}

void compileTypeDecl(void) {
  // TODO
  assert("Parsing a type delc ...");
  eat(TK_IDENT);
  eat(SB_EQ);
  compileType();
  eat(SB_SEMICOLON);
  assert("Type delc parsed!");
}
...
void compileParams2(void) {
  ...
  //assert("Params 2 parsed!");
}

void compileParam(void) {
  // TODO
  //assert("Parsing a param ...");
  switch (lookAhead->tokenType) {
  case TK_IDENT:
      eat(TK_IDENT);
      eat(SB_COLON);
...
void compileArguments(void) {
  // TODO
  //assert("Parsing a for arguments ....");
  switch (lookAhead->tokenType) {
  case SB_LPAR:
      eat(SB_LPAR);
      compileExpression();
  ...
  //assert("For arguments parsed ....");
}

void compileArguments2(void) {
  // TODO
  assert("Parsing a for arguments 2....");
  switch (lookAhead->tokenType) {
  case SB_COMMA:
      eat(SB_COMMA);
      compileExpression();
